...
import { MyFgsBioPageProps, MyFgsBioPage } from "./my-fgs-bio-page";
...
const factory: BlockFactory = (BaseBlockClass, widgetApi) => {
  /**
   *  <my-fgs-bio-page message="world!"></my-fgs-bio-page>
   */
  return class MyFgsBioPageBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): MyFgsBioPageProps {
      const attrs = this.parseAttributes<MyFgsBioPageProps>();
      return {
        ...attrs,
      };
    }
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<MyFgsBioPage {...this.props} widgetApi={widgetApi}/>, container);
    }
...
const blockDefinition: BlockDefinition = {
    name: "my-fgs-bio-page",
    factory: factory,
    attributes: widgetAttributes,
    blockLevel: 'block',
    configurationSchema: configurationSchema,
    uiSchema: uiSchema,
    label: 'My Fgs Bio Page'
};
